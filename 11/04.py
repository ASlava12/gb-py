...
class Computer(Equipment):
    ...
    def __init__(self, inventory_number: str, model: str, description: str, internal_components: list):
        super().__init__(inventory_number, model, description, EquipmentTypes.computer, {"internal_components": internal_components})
...
"""
    Не вижу смысла реализовывать другие компоненты в тестовой версии, по заданию - они есть. 
    В тестовом скрипте, можно добавить свои виды, что делает более гибким.
"""
